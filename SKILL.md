---
name: novel-writing
description: 长篇小说创作工作流skill。当用户说"写第X章"、"继续写"、"写新章节"、"帮我写小说"、"续写"时触发。适用场景：开始新章节、继续现有章节、构建新世界观、创建新角色卡。流程：读上一章→读时间线→读角色卡→写章节→更新文件。
---

# Novel Writing Skill

通用长篇小说创作工作流，适用于任何类型的长篇小说。
...
4. **Chapter log**: `creative-lib/章节日志/第X章.md`
